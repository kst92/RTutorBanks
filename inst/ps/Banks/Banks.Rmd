...
info("linear model with effects") # Run this line (Strg-Enter) to show info
...
info("Homoskedasticity & BP-Test") # Run this line (Strg-Enter) to show info
...
```{r "3___Casual_Effect_of__14",results='asis'}
library(stargazer)
...
```{r "3_1___Estimation_wit__2",eval=FALSE}
```
...
```{r "3_1___Estimation_wit__3",results='asis'}
#library(plm)
...
```{r "3_1___Estimation_wit__4",results='asis'}
...
```{r "3_1___Estimation_wit__5",results='asis'}
